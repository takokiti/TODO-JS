...
var createIncompleteList = function createIncompleteList(text) {
  ...
  completeButton.addEventListener("click", function () {
    //押された完了ボタンの親タグ(diｖ)を未完了リストから削除する
    deleteFromIncompleteList(completeButton.parentNode); //完了リストに追加要素
  ...
  deleteButton.addEventListener("click", function () {
    //押された削除ボタンの親タグ(diｖ)を未完了リストから削除する
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "36177" + '/');
